 ...
 * el participante todavía no
 * tiene sesiones disponibles.
 */
export default function SessionEmptyState() {
  return (
    <section className="sessions-empty" role="status" aria-live="polite">
      ...
      <h2 className="sessions-empty__title">{EMPTY_TITLE}</h2>

      <p className="sessions-empty__text">{EMPTY_DESCRIPTION}</p>
    </section>
  );
}
