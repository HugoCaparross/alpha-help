...
const PAGE_DESCRIPTION =
  "A lo largo del programa tendrás acceso a una introducción y nueve sesiones formativas. Cada sesión se desbloqueará automáticamente en su fecha de publicación según tu región.";
