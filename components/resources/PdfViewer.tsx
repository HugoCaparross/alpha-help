...
export default function PdfViewer({ title, pdfUrl }: PdfViewerProps) {
  ...
  if (!pdfUrl) {
    return <div className="pdf-viewer-error" role="alert"><p>{ERROR_MESSAGE}</p></div>;
  }
    ...
    <div className="pdf-viewer">
      <header className="pdf-viewer__toolbar">
        ...
        <div className="pdf-viewer__actions">
          <button type="button" className="pdf-viewer__button" onClick={handleDownload}>
      ...
      <div className="pdf-viewer__content">
        ...
        {hasError ? (
          <div className="pdf-viewer-error" role="alert"><p>{ERROR_MESSAGE}</p></div>
        ) : (
          <object data={pdfUrl} type="application/pdf" className="pdf-viewer__object" aria-label={title} onLoad={handleLoaded}>
