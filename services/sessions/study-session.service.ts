...
export const LIVE_JOIN_LEAD_MINUTES =
  15;
...
export async function getSessions(
  ...
  if (error) {
    console.error(
      "[study-session.service][getSessions]",
      error,
    );
...
export async function getSessionById(
  ...
  if (error) {
    console.error(
      "[study-session.service][getSessionById]",
      error,
    );
