export const GENDERS = ["Mujer", "Hombre", "Otros"] as const;
...
export type SocioeconomicLevel = (typeof SOCIOECONOMIC_LEVELS)[number];

export const SCHOOL_TYPES = ["Público", "Concertado", "Privado"] as const;
