 ...
 * Cuestionario CAPSM.
 *
 * La escala de acuerdo utilizada
 * actualmente en la aplicación es
 * de 6 puntos, coherente con el rango
 * permitido por questionnaire_responses:
 *
 * 1 <= answer <= 6
 */
