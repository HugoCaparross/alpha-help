...
export const accountSchema = z
  .object({
    ...
    acceptedPolicy: z.boolean().refine(
      (value) => value === true,
      {
        message:
  ...
  employmentStatus: z
    .string()
    .min(1, "Selecciona tu situación laboral"),

  maritalStatus: z
    .string()
    .min(1, "Selecciona tu estado civil"),
});
    ...
    .array(
      z.object({
        age: z
          ...
          .max(17, "La edad máxima es 17 años"),

        gender: z
          .string()
          .min(1, "Selecciona el sexo del menor"),

        psychologicalSupport: z.boolean(),
      })
    )
    .min(1, "Debes introducir al menos un hijo"),
});
